#!/usr/bin/env bash
# Labs/009-PermissionModes/doctor.sh - lab-specific pre-flight, called by scripts/doctor.sh.
...
[[ -d quips ]] || { echo "missing prior artifact: quips/ (complete Lab 008 first)" >&2; exit 1; }
