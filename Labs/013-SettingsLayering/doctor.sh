#!/usr/bin/env bash
# Labs/013-SettingsLayering/doctor.sh - lab-specific pre-flight, called by scripts/doctor.sh.
...
[[ -d quips ]] || { echo "missing prior artifact: quips/ (complete Lab 012 first)" >&2; exit 1; }
